<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TotalReviewes.aspx.cs" Inherits="admin_Default" %>
        ...
        <br />
          ...
          <div class="container"  style="margin-top:100px; overflow:auto;" align="center">
              <asp:UpdatePanel ID="upITC" UpdateMode="Conditional" ChildrenAsTriggers="true" runat="server">
                    <ContentTemplate>
<center><asp:Label ID="lblDashboard" font-size="16pt" Text="Course(s) count for each reviewer" runat="server"></asp:Label></center>
        <br />
              ...
              <br />
        <center>
            <asp:GridView ID="gvReviewerCourse" Font-Size="12pt" runat="server"  AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" 
				Height="90%" Width="70%" PageSize="9" DataSourceID="SqlDashboard" CellPadding="4" 
				ForeColor="#333333" CssClass="table-responsive" DataKeyNames="USER_ISN,REVIEWERNAME" >
                    ...
                    <Columns>
                        <asp:BoundField DataField="REVIEWERNAME" HeaderText="Reviewer name" SortExpression="REVIEWERNAME" ReadOnly="True" />
        ...
        <br/>
        <center><asp:Label ID="DetailLabel" Text="<strong>IR</strong> - Internal Review, <strong>ER</strong> - External Review" runat="server"></asp:Label></center>
              </ContentTemplate></asp:UpdatePanel>
          </div><br />

        <!-- Modal -->

    <div id="reviewerIRModal" class="modal fade in" role="dialog">
         ...
         <!-- Modal Content -->
            <div class="modal-content">
                ...
                <div id="ITCtotaldiv" class="modal-body" align="center" runat="server">
                    <div role="form" >
                        <center><b><asp:Label ID="lblTotalIRCourseCount" runat="server" ></asp:Label></b><asp:Label ID="lblIRCourseHeading" runat="server" align="right" Text=" course(s) found for &nbsp; " Width="135"></asp:Label><asp:Label ID="lblDevelopmentStatus" runat="server" ></asp:Label></center>
                        <br />
                        <div class="form-inline" >
                            <asp:GridView ID="gvReviewer" Font-Size="10pt" runat="server"  AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" 
				Height="90%" Width="90%"  PageSize="15" DataSourceID="SqlReviewerIR" CellPadding="4"
	...
	<!-- End of Modal Section -->    
        ...
        <div id="reviewerERModal" class="modal fade in" role="dialog">
        <div class="modal-dialog modal-lg">
         <!-- Modal Content -->
            <div class="modal-content">
                <div class="modal-header">
                ...
                <asp:UpdatePanel ID="upReviewerERModal" runat="server">
                    <ContentTemplate>
                <div id="Div2" class="modal-body" align="center" runat="server">
                    <div role="form" >
                        <center><b><asp:Label ID="lblTotalERCourseCount" runat="server" ></asp:Label></b><asp:Label ID="lblERCourseHeading" runat="server" align="right" Text=" course(s) found for &nbsp; " Width="135"></asp:Label><asp:Label ID="lblERReviewerName" runat="server" ></asp:Label></center>
                        <br />
                        <div class="form-inline" >
                            <asp:GridView ID="gvERReviewer" Font-Size="10pt" runat="server"  AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" 
				Height="90%" Width="90%"  PageSize="15" DataSourceID="SqlReviewerER" CellPadding="4"
				ForeColor="#333333" CssClass="table-responsive">
				<Columns>
                    ...
                    <SelectedRowStyle BackColor="#E2DED6" Font-Bold="True" ForeColor="#333333" />
                        ...
                        <div class="form-group">
							<div class="modal-footer" >
								<center> <asp:Button ID="btnClose" runat="server" CssClass="btn btn-primary btn-sm" data-dismiss="modal" CausesValidation="false" Height="30px" Text="Close" Width="75px" /></center>
							</div>
                        </div>
                    </div>
                </div>
